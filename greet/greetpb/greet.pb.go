...
func (x *LogGreetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LogGreetRequest) ProtoMessage() {}

func (x *LogGreetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LogGreetRequest.ProtoReflect.Descriptor instead.
func (*LogGreetRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{5}
}

func (x *LogGreetRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
func (x *GreetEveryOneRequest) GetResult() *Greeting {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x3e, 0x0a, 0x0f, 0x4c, 0x6f, 0x67, 0x47,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x3f, 0x0a, 0x14, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45, 0x76,
	0x65, 0x72, 0x79, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a,
	...
	0x76, 0x65, 0x72, 0x79, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xac, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65,
	...
	0x01, 0x12, 0x41, 0x0a, 0x09, 0x4c, 0x6f, 0x6e, 0x67, 0x67, 0x72, 0x65, 0x65, 0x74, 0x12, 0x16,
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x4c, 0x6f, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52,
	...
	0x72, 0x79, 0x4f, 0x6e, 0x65, 0x12, 0x1b, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72,
	...
	0x45, 0x76, 0x65, 0x72, 0x79, 0x4f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*LogGreetRequest)(nil),        // 5: greet.LogGreetRequest
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0, // 2: greet.LogGreetRequest.greeting:type_name -> greet.Greeting
	0, // 3: greet.GreetEveryOneRequest.result:type_name -> greet.Greeting
	...
	5, // 6: greet.GreetService.Longgreet:input_type -> greet.LogGreetRequest
...
func (x *greetServiceLonggreetClient) Send(m *LogGreetRequest) error {
...
func (x *greetServiceLonggreetServer) Recv() (*LogGreetRequest, error) {
	m := new(LogGreetRequest)
